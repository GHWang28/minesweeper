  ...
  return transitions((style, sweepedTransition) => (
    <AnimatedBox
      ...
      sx={{
        ...
        filter: (sweepedTransition) ? 'brightness(0.75)' : 'brightness(1)',
        cursor: 'pointer',
        display: 'flex',
        alignItems: 'center',
