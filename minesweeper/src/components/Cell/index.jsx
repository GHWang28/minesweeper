...
export default function Cell ({ onClick, data, startOfGame }) {
  ...
  const generateColor = () => {
    ...
    const charred = Math.max(20, 110 - data.charred * 10);
  ...
  return transitions((style, sweepedTransition) => (
    <AnimatedBox
      ...
      sx={{
        width: '100%',
        height: '100%',
        border: (data.isGameOver) ? '1px solid black' : '1px solid forestgreen',
